...
describe('Signup', () => {
  ...
  test('Fill the form', () => {
    ...
    userEvent.type(screen.getByPlaceholderText('Username*'), 'My name');
    expect(screen.getByPlaceholderText('Username*')).toHaveValue('My name');
  ...
  test('Username is too short (minimum is 3 characters)', async () => {
    ...
    userEvent.type(screen.getByPlaceholderText('Username*'), 'My');
